...
TEST(KalmanFilter, testFunctionality)
{
  ...
  const std::vector<double> error_cov_estimates = { 1.,           0.0909090909, 0.0476190476, 0.0322580645,
                                                    0.0243902439, 0.0196078431, 0.0163934426, 0.014084507,
                                                    0.012345679,  0.010989011 };
  const std::vector<double> state_updates = { 0.3545454545, 0.4238095238, 0.4419354839, 0.4048780488, 0.3745098039,
                                              0.3655737705, 0.361971831,  0.3765432099, 0.3802197802, 0.3871287129 };
  const std::vector<double> error_cov_updates = { 0.0909090909, 0.0476190476, 0.0322580645, 0.0243902439, 0.0196078431,
                                                  0.0163934426, 0.014084507,  0.012345679,  0.010989011,  0.0099009901 };
  ...
  for (int i = 0; i < measurements.size(); i++)
  {
    ...
    measurement.clear();
    measurement.push_back(measurements[i]);
...
TEST(KalmanFilter, testParameters)
{
  ...
  const std::vector<std::string> namespaces_with_param_errors = { "KalmanFilterTestWithoutParameters",
                                                                  "KalmanFilterTestDt",
                                                                  "KalmanFilterTestN",
                                                                  "KalmanFilterTestN",
